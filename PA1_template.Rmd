...
- **Mean**: `r tot_steps_per_day_summary[["Mean"]]`
- **Median**: `r tot_steps_per_day_summary[["Median"]]`
...
The max number of steps interval is `r int_max_num_steps`
